...
<!-- no picture: in the core the switch is an owner-only API; the key-shelf card that shows it belongs to the live feed module, which a core demo office does not load (added 13 September 2026) -->
