...
export const LIBRARY = [
  ...
  { id: 'floor1', dir: 'floor', tier: 'room', row: 0,
  ...
  { id: 'art', dir: 'decor', tier: 'room', row: 1,
  ...
  { id: 'board', dir: 'work', tier: 'room', row: 2,
  ...
  { id: 'task', dir: 'work', tier: 'room', row: 3,
  ...
  { id: 'cctv', dir: 'floor', tier: 'room', row: 4,
  ...
  { id: 'radio', dir: 'decor', tier: 'room', row: 5, module: 'radio',
  ...
  { id: 'dress', dir: 'you', tier: 'room', row: 6,
  ...
  { id: 'agents', dir: 'people', tier: 'room', row: 7,
  ...
  { id: 'talk', dir: 'talk', tier: 'room', row: 8,
  ...
  { id: 'door', dir: 'floor', tier: 'room', row: 9,
  ...
  { id: 'bible', dir: 'floor', tier: 'office', row: 0, parent: 'floor1', module: 'bible',
  ...
  { id: 'easel', dir: 'work', tier: 'office', row: 1, parent: 'board', module: 'easel',
  ...
  { id: 'gittree', dir: 'work', tier: 'office', row: 2, parent: 'board', module: 'gittree',
  ...
  { id: 'floor', dir: 'people', tier: 'floor', row: 7, parent: 'agents',
  ...
  { id: 'meet', dir: 'talk', tier: 'floor', row: 8, parent: 'talk',
...
// Six directions of the office — the detailed view of the tree, where each of
// them opens its own branch. They exist only in that view: the flat columns
// stay the default and know nothing about directions.
//
...
export const DIRS = [
  ...
  { id: 'work', name: { ru: 'РАБОТА', en: 'WORK' } },
  { id: 'talk', name: { ru: 'РАЗГОВОР', en: 'TALK' } },
  { id: 'decor', name: { ru: 'ДЕКОР', en: 'DECOR' } },
  { id: 'you', name: { ru: 'ТЫ', en: 'YOU' } },
];

// What sits inside a node. Kept beside the tree rather than in it: a node is a
// thing you walk up to, these are the switches on it, and five more strings in
// every entry would bury the tree the file is about. Drawn only where the panel
// is wide enough to hold them — below that they live in the card, one line.
export const SUBS = {
  floor1: [{ ru: 'Комнаты по проектам', en: 'Rooms per project' }, { ru: 'Таблички', en: 'Door plates' }, { ru: 'Лифт и крыша', en: 'The lift and the roof' }],
  cctv: [{ ru: 'Камеры по этажу', en: 'Floor cameras' }, { ru: 'Автообход', en: 'Auto round' }],
  door: [{ ru: 'Титульный экран', en: 'The title screen' }, { ru: 'Два языка', en: 'Two languages' }],
  agents: [{ ru: 'Статусы и пузыри', en: 'Statuses and bubbles' }, { ru: 'Роли и профессии', en: 'Roles and trades' }, { ru: 'Внешность и имена', en: 'Looks and names' }],
  board: [{ ru: 'Доска работ', en: 'The work board' }, { ru: 'Заметки в разговоре', en: 'Notes in a conversation' }, { ru: 'Все заметки разом', en: 'All notes at once' }],
  task: [{ ru: 'Записка на стол', en: 'A note on the desk' }, { ru: 'Отправить в чат', en: 'Send into the chat' }],
  talk: [{ ru: 'Транскрипт', en: 'The transcript' }, { ru: 'Разметка и подсветка', en: 'Markup and highlighting' }, { ru: 'Копирование', en: 'Copying' }],
  art: [{ ru: 'Картины и пасхалки', en: 'Paintings and easter eggs' }, { ru: 'Кот, скейт, футбол', en: 'The cat, the skate, football' }, { ru: 'Погода и время суток', en: 'Weather and time of day' }],
  radio: [{ ru: 'lofi и пианино', en: 'lofi and piano' }, { ru: 'Своя волна · твой ключ', en: 'Your own wave · your key' }],
  dress: [{ ru: 'Свой персонаж', en: 'Your character' }, { ru: 'Дресс-код на этаж', en: 'A dress code for the floor' }, { ru: 'Инвентарь и ключи', en: 'Inventory and keys' }],
  ...
  meet: [{ ru: 'Звук', en: 'Sound' }, { ru: 'Комната для людей', en: 'A room for people' }],
  guest: [{ ru: 'Выдать и отозвать', en: 'Issue and revoke' }, { ru: 'Согласие хозяина', en: 'The owner’s consent' }],
};
...
export const dirTally = (dir, lit) => {
  ...
  return { free: !paid.length, own: all.filter(lit).length, total: all.length };
};
